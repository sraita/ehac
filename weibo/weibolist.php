...
<html>
  <head>
    ...
    <!-- Path to Framework7 Library CSS-->
      <link rel="stylesheet" href="../ehac/css/framework7.min.css">
      <link rel="stylesheet" href="../ehac/css/framework7.themes.min.css">
    <!-- Path to your custom app styles-->
    <link rel="stylesheet" href="../ehac/css/todo7.css">
				...
				<ul>
				  <li  valign="bottom" class="fengmian card demo-card-header-pic no-border">
					  <div  class="card-header color-white no-border">
						<div class="facebook-avatar"><img src="<?php echo $userinfo["profile_image_url"];?>" width="44" height="44"></div>
						<div class="facebook-name"><?php echo $userinfo["screen_name"];?></div>
						<div class="facebook-date"><?php  echo $userinfo["sex"];?></div>
					  </div>
					  <div class="card-content">
						<div class="card-content-inner">
						 <p class="color-white"><?php echo $userinfo["description"];?></p>
...
<div  class="popup popup-face-group no-navbar no-toolbar no-swipeback">
  ...
  <div class="content-block login-screen-content">
    ...
    <script type="text/javascript" src="../ehac/js/framework7.min.js"></script>
    <script type="text/javascript" src="../ehac/js/todo71.js"></script>
  </body>
</html> 
